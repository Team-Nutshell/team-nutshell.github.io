...
const fragmentShader = `	const M_PI: f32 = 3.1415926535897932384626433832795;
	...
	fn main(@location(0) uv: vec2f) -> @location(0) vec4f {
		...
		let dim: vec2f = vec2f(800.0, 600.0);
...
var canvasAndFragmentShader = document.querySelector("#webgpuCanvasAndFragmentShader");
canvasAndFragmentShader.style.width = "100%";
var canvas = document.querySelector("#webgpuCanvas");
canvas.style.float = "left";
var editableFragmentShader = document.querySelector("#webgpuFragmentShader");
editableFragmentShader.style.float = "left";
editableFragmentShader.style.width = "600px";
editableFragmentShader.style.height = "600px";
editableFragmentShader.style.marginLeft = "10px";
editableFragmentShader.style.marginRight = "10px";
...
compilationMessage.style.width = "90%";
compilationMessage.style.marginLeft = "10px";
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const fragmentShaderModule = this.device.createShaderModule({
                ...
                code: bindGroupFragmentShader + fragmentShader
            });
    ...
    update(timestamp) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (refreshFragmentShader) {
                const fragmentShaderModule = this.device.createShaderModule({
                    label: "Fragment shader module",
                    code: bindGroupFragmentShader + editableFragmentShader.textContent
                });
